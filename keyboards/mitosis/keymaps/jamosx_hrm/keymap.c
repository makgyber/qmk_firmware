...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_STD] = LAYOUT( /* Standard; as compatible with dvorak and qwerty as possible */
    ...
    CTL_A,  ALT_S,  SFT_D,  GUI_F,    KC_G,         KC_H,      GUI_J,    SFT_K,    ALT_L, CTL_SCLN,
    KC_Z, KC_X,  KC_C,    KC_V,    KC_B,    KC_N,      KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
              _______, _______,_______, MO(_NUM),         MO(_NUM), _______, _______, _______,
              KC_LSFT, KC_LCTL,LT(_FN, KC_SPC),KC_ENT,    KC_SPC, LT(_FN, KC_BSPC),  KC_RALT, KC_ENT
  ),
  ...
  [_FN] = LAYOUT( /* Function Layer, primary alternative layer featuring numpad on right hand,
    ...
    KC_LSFT, C(KC_LEFT), C(KC_DOWN), C(KC_RIGHT), KC_LBRC,       KC_RBRC, KC_BTN1, KC_BTN2, KC_9, KC_ENT,
             _______, _______, _______, _______,       _______, _______, _______, _______,
             _______, _______, _______, _______,       _______, _______, _______, _______
  ), 
