...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_STD] = LAYOUT( /* Standard; as compatible with dvorak and qwerty as possible */
    ...
    KC_Z,        KC_X,    KC_C,    KC_V,    KC_B,         KC_N,      KC_M,    KC_COMM, KC_DOT,  KC_ENT,
              _______, _______,_______, MO(_NUM),          MO(_NUM), _______, _______, _______,
              _______, KC_LCTL,LT(_FN, KC_SPC),GUI_T(KC_ENT),    SFT_T(KC_SPC),LT(_FN, KC_BSPC),  KC_RALT, _______
  ),
  ...
  [_FN] = LAYOUT( /* Function Layer, primary alternative layer featuring numpad on right hand,
    ...
    KC_ESC,  _______, KC_UP, _______, KC_GRV,       KC_BSLS, KC_WH_L, KC_MS_UP, KC_BSPC, KC_DEL,
    KC_TAB,  KC_LEFT, KC_DOWN, KC_RIGHT, KC_MINS,       KC_EQL, KC_MS_L, KC_MS_D, KC_MS_R, KC_QUOT,
    KC_LSFT, C(KC_LEFT), C(KC_DOWN), C(KC_RIGHT), KC_LBRC,       KC_RBRC, KC_BTN1, KC_BTN2, KC_9,  KC_SLSH,
             _______, _______, _______, _______,       _______, _______, _______, _______,
             _______, _______, _______, _______,       _______, _______, _______, _______
  ),
