...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( /* Malt Layout, customised for reduced columns (ex: quote and shift locations) */
    KC_Q, KC_W,    KC_E,    KC_R,    KC_T,      KC_Y,      KC_U,    KC_I,    KC_O,    KC_P,
    KC_A, KC_S,    KC_D,    KC_F,    KC_G,      KC_H,      KC_J,    KC_K,    KC_L,    KC_SCLN,
    SHIFT, KC_X,    KC_C,    KC_V,    KC_B,      KC_N,      KC_M,    KC_COMM, KC_DOT,  KC_ENT,
             M(VOLU), M(ESCM), KC_TAB, KC_LCTL,        KC_RGUI, KC_SLSH,  KC_DEL,  KC_PGUP,
             M(VOLD), KC_QUOT, KC_Z,  FNKEY,          SHIFT,  KC_SPC,  KC_BSPC, KC_LALT
  ),
  ...
  [_FUNCTION] = LAYOUT( /* Function Layer, RSprimary alternative layer featuring numpad on right hand,
    ...
    KC_ASTR, KC_UNDS, KC_EXLM, KC_DLR,  KC_BSLS,       KC_LCBR, KC_1,    KC_2,    KC_3,    KC_ENT,
             KC_HOME, KC_GRV,  _______, _______,       _______, KC_EQL,  KC_TILD, KC_DOT,
  ...
  [_FUNCSHIFT] = LAYOUT( /* Function Shifted Layer, secondary alternative layer with closing brackets,
    ...
    _______, _______, _______, _______, _______,       KC_RCBR, KC_F1,   KC_F2,   KC_F3,   KC_F12,
             _______, _______, KC_PWR, _______,       _______, _______, _______, _______,
             _______, _______, _______, _______,       _______, _______, _______, _______
  )
